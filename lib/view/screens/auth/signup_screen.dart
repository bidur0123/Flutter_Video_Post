...
import 'package:blackcofferr/view/widgets/glitch.dart';
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child : Column(
            ...
            children: [
              GlithEffect(child: const Text("Welcome To BlacKCoffer" ,style: TextStyle(fontWeight: FontWeight.w900 , fontSize: 30),)),
